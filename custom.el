...
(custom-set-variables
 ...
 '(package-selected-packages
   '(notmuch-addr ztree add-node-modules-path urlenc jinja2-mode slack editorconfig markdown-mode counsel magit wgrep jsonian-mode jsonian org-mode svgo languagetool ts-fold use-package html-mode ace-window ag all-the-icons all-the-icons-dired atomic-chrome auto-complete auto-package-update company counsel-css counsel-projectile dockerfile-mode doom-themes dracula-theme edit-indirect edit-server elpy emojify eshell-toggle exec-path-from-shell expand-region flycheck flycheck-mode gh-md glsl-mode iedit js-doc json-mode kotlin-mode lispy neotree nginx-mode pcre2el polymode presentation prettier prettier-js-mode prettier-mode projectile projectile-ripgrep rainbow-mode restclient smart-mode-line string-inflection swift-mode tide use-packages visual-regexp visual-regexp-steroids web-mode with-editor yaml-mode yasnippet zenburn-theme))
