(custom-set-variables
 ...
 '(package-selected-packages
   '(apache-mode restclient dockerfile-mode smart-mode-line swift-mode edit-indirect exec-path-from-shell yasnippet projectile-ripgrep use-package presentation polymode magit doom-themes tide all-the-icons all-the-icons-dired company projectile visual-regexp web-mode with-editor pcre2el visual-regexp-steroids ace-window nginx-mode prettier-js yaml-mode typescript-mode gh-md emojify add-node-modules-path drag-stuff iedit rainbow-mode expand-region js-doc auto-complete ag json-mode flycheck markdown-mode editorconfig flx-ido neotree))
