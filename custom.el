...
(custom-set-variables
 ...
 '(ag-ignore-list
   '("node_modules" "*.map" "main.*.*" "*.snap" "*.min.js" "lib" "es"
     "vendorAssets" "dist" "dist-es2015"))
 ...
 '(auth-sources
   '(macos-keychain-internet macos-keychain-generic "~/.authinfo.gpg" "~/.authinfo"))
 '(biomejs-format-biome-args '("format"))
 '(biomejs-format-biome-command "biome")
 '(biomejs-format-show-errors 'echo)
 ...
 '(gptel-directives
   '((default
      . "You are a large language model living in Emacs and a helpful assistant. Respond concisely. Do not make anything up; respond only with information that is objectively true and factual.")
     (programming
      . "You are a large language model and a careful programmer. Provide code and only code as output without any additional text, prompt or note. Write code that is concise, easy to read, and maintainable. Do not use any syntax or symbols that aren't objectively real and documented.")
     (writing
 ...
 '(package-selected-packages
   '(add-node-modules-path all-the-icons-completion all-the-icons-dired
                           biomejs-format consult eat edit-indirect elpy
                           exec-path-from-shell flymake-json flymake-stylelint
                           glsl-mode gptel iedit indent-bars jsdoc languagetool
                           ligature lsp-ui magit marginalia nix-mode noccur
                           orderless presentation prettier pug-mode rainbow-mode
                           string-inflection swift-mode tree-sitter-langs
                           treesit-auto vertico vterm web-mode wgrep
                           zenburn-theme))
 ...
 '(projectile-globally-ignored-directories
   '(".idea" ".ensime_cache" ".eunit" ".git" ".hg" ".fslckout" "_FOSSIL_" ".bzr"
     "_darcs" ".tox" ".svn" ".stack-work" "lib" "es" "build" "docs" "dist"))
